...
- **A rider card on hover.** On a computer, rest the pointer on any rider's name for a moment and a small card opens under it: the rider's flag and name, what this site holds about their season (wins, counting one-day races, overall classifications and stages together, and race podiums), and links to their ProCyclingStats and Wikipedia pages. The Wikipedia link goes to the rider's exact article wherever the race pages we read link to it, so a name shared with other people, such as Ben Healy, lands on the cyclist and not on a list. Move away or press Escape to close it. The figures come only from results already on this site, so they say "on this site": every WorldTour and Worlds podium of the season, and stage wins from the stage results the page shows. Clicking the name still goes straight to ProCyclingStats, and on a phone, where there is no hover, nothing changes.
